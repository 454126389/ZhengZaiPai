...
import com.AVD.WI_FTP.sender.SHAREthemActivity;
...
public class HotspotControl {
     ...
     * @param port Port number assigned to {@link com.AVD.WI_FTP.sender.SHAREthemServer}, not used anywhere in {@link HotspotControl} but helps {@link SHAREthemActivity} to display port info
