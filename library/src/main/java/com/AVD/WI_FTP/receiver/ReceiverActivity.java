...
import static com.AVD.WI_FTP.receiver.ReceiverActivity.WifiTasksHandler.SCAN_FOR_WIFI_RESULTS;
import static com.AVD.WI_FTP.receiver.ReceiverActivity.WifiTasksHandler.WAIT_FOR_CONNECT_ACTION_TIMEOUT;
import static com.AVD.WI_FTP.receiver.ReceiverActivity.WifiTasksHandler.WAIT_FOR_RECONNECT_ACTION_TIMEOUT;
import static com.AVD.WI_FTP.utils.WifiUtils.connectToOpenHotspot;
...
//    Toolbar m_toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1 = (Button) findViewById(R.id.fback);
        b1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent fb = new Intent(ReceiverActivity.this,Fback.class);
                startActivity(fb);
            }
        });
