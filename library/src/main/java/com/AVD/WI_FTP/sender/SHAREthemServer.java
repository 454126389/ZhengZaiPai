...
class SHAREthemServer extends NanoHTTPD {
    ...
    /**
     * Creates an Error {@link com.AVD.WI_FTP.sender.NanoHTTPD.Response} with
     *
     * @param status  error Status like <code>Response.Status.FORBIDDEN</code>
     * @param message error message
     * @return {@link com.AVD.WI_FTP.sender.NanoHTTPD.Response}
     */
    ...
    /**
     * Creates a success {@link com.AVD.WI_FTP.sender.NanoHTTPD.Response} with Shared Files URLS data in @{@link com.google.gson.JsonArray} format
     *
     * @return {@link com.AVD.WI_FTP.sender.NanoHTTPD.Response}
     */
