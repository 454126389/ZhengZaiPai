...
import com.AVD.WI_FTP.utils.DividerItemDecoration;
import com.AVD.WI_FTP.utils.RecyclerViewArrayAdapter;
import com.AVD.WI_FTP.utils.Utils;
...
import static com.AVD.WI_FTP.sender.SHAREthemActivity.ShareUIHandler.LIST_API_CLIENTS;
import static com.AVD.WI_FTP.sender.SHAREthemActivity.ShareUIHandler.UPDATE_AP_STATUS;
import static com.AVD.WI_FTP.utils.Utils.getRandomColor;
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        m_sender_ap_switch_listener = new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    //If target version is MM and beyond, you need to check System Write permissions to proceed.  高版本要权限申请
    ...
    //region: Dialog utilities  支持自定义监听的对话框
    ...
    //region: Hotspot Control  开启共享局域网
